...
data class R32byte(
    ...
    override fun neg(): Int32 = R32byte(-intValue())

    override fun add(o: Int32): Int32 = R32byte(intValue() + o.intValue())

    override fun sub(o: Int32): Int32 = R32byte(intValue() - o.intValue())

    override fun mult(o: Int32): Int32 = R32byte(intValue() * o.intValue())
